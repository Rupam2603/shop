              ...
              {mode === "login" && (
                <form onSubmit={handleLogin} className="flex flex-col gap-4">
                  ...
                  <div className="flex items-center gap-3 my-1">
                    <div className="flex-1 h-px bg-[#e0eae0]" />
                    <span className="text-[10px] text-[#93a496] uppercase font-bold tracking-widest">
                      Or Fast Authentication
                    </span>
                    <div className="flex-1 h-px bg-[#e0eae0]" />
                  </div>

                  {/* Clerk Google Single Sign-On */}
                  <SignInButton mode="modal" fallbackRedirectUrl="/" forceRedirectUrl="/">
                    <button
                      ...
                      className="w-full py-3 px-4 rounded-2xl border border-[#d6e3d5] bg-white/70 hover:bg-white text-[#073b4c] text-xs sm:text-sm font-bold flex items-center justify-center gap-3 transition-all shadow-xs hover:shadow-md cursor-pointer active:scale-[0.99]"
                    >
                      ...
                      <span>Continue with Clerk Fast SSO</span>
                    </button>
                  </SignInButton>
                </form>
              )}
              ...
              {mode === "signup" && (
                <form onSubmit={handleSignup} className="flex flex-col gap-3.5">
                  ...
                  <div className="flex items-center gap-3 my-0.5">
                    <div className="flex-1 h-px bg-[#e0eae0]" />
                    <span className="text-[10px] text-[#93a496] uppercase font-bold tracking-widest">Or Sign Up With</span>
                    <div className="flex-1 h-px bg-[#e0eae0]" />
                  </div>
                  ...
                  <SignUpButton mode="modal" fallbackRedirectUrl="/" forceRedirectUrl="/">
                    <button
                      ...
                      className="w-full py-2.5 px-4 rounded-2xl border border-[#d6e3d5] bg-white/70 hover:bg-white text-[#073b4c] text-xs sm:text-sm font-bold flex items-center justify-center gap-2.5 transition-all shadow-xs hover:shadow-md cursor-pointer"
                    >
                      <svg width="18" height="18" viewBox="0 0 24 24">
                        <path fill="#4285F4" d="M23.745 12.27c0-.7-.06-1.4-.19-2.07H12v4.51h6.6c-.29 1.52-1.14 2.82-2.4 3.68v3.05h3.88c2.27-2.09 3.665-5.17 3.665-9.17z"/>
                        <path fill="#34A853" d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.88-3.05c-1.08.72-2.45 1.16-4.05 1.16-3.12 0-5.77-2.1-6.72-4.93H1.25v3.15C3.26 21.36 7.33 24 12 24z"/>
                      ...
                      <span>Fast Sign Up with Clerk</span>
                    </button>
                  </SignUpButton>

                  <p className="text-center text-[10px] text-[#869989] leading-normal">
